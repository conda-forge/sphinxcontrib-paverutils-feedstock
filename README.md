About sphinxcontrib-paverutils-feedstock
========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-paverutils-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3572&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-paverutils-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-paverutils` can be installed with `conda`:
...
```
mamba install sphinxcontrib-paverutils
```

It is possible to list all of the versions of `sphinxcontrib-paverutils` available on your platform with `conda`:
...
```
mamba search sphinxcontrib-paverutils --channel conda-forge
```
...
mamba repoquery search sphinxcontrib-paverutils --channel conda-forge

# List packages depending on `sphinxcontrib-paverutils`:
mamba repoquery whoneeds sphinxcontrib-paverutils --channel conda-forge

# List dependencies of `sphinxcontrib-paverutils`:
mamba repoquery depends sphinxcontrib-paverutils --channel conda-forge
```
